...
class DetailsTableViewController: UITableViewController {
    ...
    override func tableView(_: UITableView, numberOfRowsInSection _: Int) -> Int {
        ...
        return shakespeare.propertyNames().count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cellIdentifier = "nameValueCell"
        ...
        // Configure the cell...
        let property = shakespeare.propertyNames()[indexPath.row]
        cell.propertyNameLabel.text = property.label
        cell.propertyValueLabel.text = String(describing: property.value)
        return cell
    }
